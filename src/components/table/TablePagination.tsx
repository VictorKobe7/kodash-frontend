import { FormControl, Grid, MenuItem, Pagination, Select, type SelectChangeEvent, Stack, TextField, Typography } from "@mui/material";
import { type TableState, type Updater } from "@tanstack/react-table";
...
export const TablePagination = ({ getPageCount, setPageIndex, setPageSize, getState, initialPageSize }: TablePaginationProps) => {
    ...
    <Grid spacing={1} container alignItems="center" justifyContent="space-between" sx={{ width: "auto" }}>
      <Grid>
        <Stack direction="row" spacing={1} alignItems="center">
          <Stack direction="row" spacing={1} alignItems="center">
            <Typography variant="caption" color="text.secondary">Linhas por página</Typography>
            <FormControl sx={{ m: 1 }}>
              <Select
                open={open}
                onClose={handleClose}
